...
##### FILL BY STUDENTS #####
change_selection [get_timing_paths -from bit_secure_8/sipo_slice_last/wr_addr_reg[0] -to bit_secure_8/sipo_slice_last/wr_addr_reg[0]]
##### FILL BY STUDENTS #####

# Create False paths to ignore
##### FILL BY STUDENTS #####
set_false_path -from bit_secure_3/lreset_sync/reset_sync_reg -to bit_secure_3/slice_9/sipo_bit/rd_addr_reg[1]
##### FILL BY STUDENTS #####
